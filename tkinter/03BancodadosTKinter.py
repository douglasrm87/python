...
class Cadastro (tk.Frame): 
    ...
    def desenharTela(self): 
        ...
        self.listaTela = tk.Listbox (self.master, width=50, borderwidth=5, selectborderwidth=0, relief=tk.FLAT ) 
        self.listaTela.grid(row=6, column=1) 
    ...
    def selecionarRegistro(self): 
        ...
        for reg in registros: 
            ...
            self.listaTela.insert(linha,reg) 
            linha = linha + 1 
